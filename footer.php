<div id ="footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <ul class="menu-list">
                    ...
                    <?php if(!empty($footer[0]['contact_phone'])){ ?>
                        <li><i class="fa fa-phone" ></i><span>: <a href="tel:<?php echo $footer[0]['contact_phone']; ?>"><?php echo $footer[0]['contact_phone']; ?></a></span></li>
                    <?php } ?>
            ...
            <div class="col-md-12">
                <span><?php echo $footer[0]['footer_text'] ?> | Created by Lamp Lumineers</span>
            </div>
        </div>
    </div>
</div>
